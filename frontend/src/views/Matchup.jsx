...
const PLAYERS = [
  ...
  { id: 2,  name: 'Xander Schauffele' },
  { id: 3,  name: 'Collin Morikawa' },
  { id: 4,  name: 'Tommy Fleetwood' },
  { id: 5,  name: 'Shane Lowry' },
  { id: 6,  name: 'Patrick Cantlay' },
  { id: 7,  name: 'Ludvig Åberg' },
  { id: 8,  name: 'Wyndham Clark' },
  { id: 9,  name: 'Russell Henley' },
  { id: 10, name: 'Brian Harman' },
  { id: 11, name: 'Sepp Straka' },
  { id: 12, name: 'Matt Fitzpatrick' },
  { id: 13, name: 'Adam Scott' },
  { id: 14, name: 'Sahith Theegala' },
  { id: 15, name: 'Chris Kirk' },
  { id: 16, name: 'Sungjae Im' },
  { id: 17, name: 'Keith Mitchell' },
  { id: 18, name: 'Callum Shinkwin' },
  { id: 19, name: 'Austin Eckroat' },
  { id: 20, name: 'J.T. Poston' },
  { id: 21, name: 'Beau Hossler' },
  { id: 22, name: 'Davis Riley' },
  { id: 23, name: 'Brendon Todd' },
  { id: 24, name: 'Webb Simpson' },
  { id: 25, name: 'Joel Dahmen' },
  { id: 26, name: 'Harry Hall' },
  { id: 27, name: 'Mackenzie Hughes' },
  { id: 28, name: 'Chesson Hadley' },
  { id: 29, name: 'Wesley Bryan' },
  { id: 30, name: 'Ryan Fox' },
  { id: 31, name: 'Nicolai Hojgaard' },
  { id: 32, name: 'Thomas Detry' },
  { id: 33, name: 'Aaron Rai' },
  { id: 34, name: 'Byeong Hun An' },
  { id: 35, name: 'Mark Hubbard' },
  { id: 36, name: 'Patrick Rodgers' },
  { id: 37, name: 'Doc Redman' },
  { id: 38, name: 'Camilo Villegas' },
  { id: 39, name: 'Peter Malnati' },
]
